# -*- coding: utf-8 -*-
"""
9.9包邮代理 v5.0 - 腾讯云SCF Web函数
函数名：jd-99-baoyou-proxy
...
# ===== 爆品标签集合 =====
HOT_TAGS = {"9.9", "9.9包邮", "包邮", "超值", "低价", "特惠", "限时优惠", "热销", "爆款", "超万人正在疯抢", "同款高转化"}
