...
version: ""
license: ""
installCmd: "hermes skills install clawhub/bid-proposal-manager"
sourceUrl: "https://clawhub.ai/skills/bid-proposal-manager"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/bid-proposal-manager`
- **Source URL:** [https://clawhub.ai/skills/bid-proposal-manager](https://clawhub.ai/skills/bid-proposal-manager)
...
```bash
hermes skills install clawhub/bid-proposal-manager
```
