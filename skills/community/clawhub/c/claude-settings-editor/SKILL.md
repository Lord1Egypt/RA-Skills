...
version: ""
license: ""
installCmd: "hermes skills install clawhub/claude-settings-editor"
sourceUrl: "https://clawhub.ai/skills/claude-settings-editor"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/claude-settings-editor`
- **Source URL:** [https://clawhub.ai/skills/claude-settings-editor](https://clawhub.ai/skills/claude-settings-editor)
...
```bash
hermes skills install clawhub/claude-settings-editor
```
