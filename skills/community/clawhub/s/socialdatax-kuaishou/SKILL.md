...
npx -y socialdatax-skills@latest kuaishou user-search --keyword "<creator_keyword>" --pages 3 --pretty
...
Use search for 快手内容研究 and work discovery, user-search for creator/account candidate discovery before profile lookup, detail for one work, comments/replies for 评论分析和评论回复分析, user-info for 达人信息, and user-posts for 达人作品.
