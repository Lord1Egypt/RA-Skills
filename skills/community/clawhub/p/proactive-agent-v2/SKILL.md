...
version: ""
license: ""
installCmd: "hermes skills install clawhub/proactive-agent-v2"
sourceUrl: "https://clawhub.ai/skills/proactive-agent-v2"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/proactive-agent-v2`
- **Source URL:** [https://clawhub.ai/skills/proactive-agent-v2](https://clawhub.ai/skills/proactive-agent-v2)
...
```bash
hermes skills install clawhub/proactive-agent-v2
```
