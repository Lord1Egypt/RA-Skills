# Feedback Log — Figma to Mobile

This file captures user corrections to generated code, enabling pattern analysis and rule refinement.
...
Recommended location (project-local): `.trae/figma-to-mobile/feedback-log.md`

Run `scripts/feedback_analyze.py` to analyze patterns.
