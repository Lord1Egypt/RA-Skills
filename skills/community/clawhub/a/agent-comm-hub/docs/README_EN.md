...
```bash
# 1. Start the Hub (with data persistence)
...
| **Transport** | 3 | SSE push + HTTP POST + WebSocket |

**53 MCP tools** · SQLite WAL (zero message loss) · SSE / WebSocket push latency < 50ms
...
| [Security Policy](../SECURITY.md) | Security mechanisms, vulnerability reporting |
