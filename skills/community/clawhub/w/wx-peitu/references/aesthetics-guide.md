...
**IMPORTANT**: The original scale below was calibrated for PPT/小红书 at 1080px+ canvas. For WeChat public account illustrations at 640px, use the **WeChat Card Type Scale** instead.

#### Original Scale (1080px+ canvas, PPT/小红书)

| Role | Size (1080px canvas) | Weight | Tracking | Rationale |
|------|---------------------|--------|----------|-----------|
| Display/Hero | 88-124px | 200-400 | +0.04em | Light weight at large size = elegance |
| Section title | 56-88px | 400-500 | +0.03em | Medium weight anchors hierarchy |
| Body | 24-28px | 400-500 | normal | Standard reading weight |
| Captions/meta | 21-24px | 500-650 | +0.1-0.22em | Small text needs heavier weight |

#### WeChat Card Type Scale (640px canvas, 公众号配图) ⭐ USE THIS

Recalibrated for 640px width. Max ratio between largest and smallest: **4:1** (not 7:1).

| Role | Size (640px canvas) | Weight | Tracking | Rationale |
|------|---------------------|--------|----------|-----------|
| Display/Hero | 36-44px | 300-400 | +0.03em | Confident but not overwhelming |
| Section title | 24-32px | 400-500 | +0.02em | Clear hierarchy anchor |
| Body | 14-16px | 400-500 | normal | Comfortable reading on mobile |
| Captions/meta | 10-12px | 500-600 | +0.1-0.15em | Legible at small size |
| Data numbers | 28-36px | 300-400 | normal | Numbers in metric cards — larger than body, smaller than titles |

**Hard rules**:
- A 44px+ title at weight 600+ instantly downgrades design from "premium" to "generic landing page"
- Chinese display text: weight 500 max (serif) or 300-400 (sans)
- Numbers in data cards: weight 300-400 at large size, 500-600 at small size
- **Exception**: brand name / logo text can use 700+ regardless of size
- **WeChat covers (900×383px)**: Display can go up to 48px since canvas is wider
- **1:1 square cards (640×640px)**: Display max 36px, body 16px — tighter scale for square format
...
- The 640px scale is calibrated so the ratio between largest and smallest text stays within 4:1 — beyond this, the hierarchy breaks and small text becomes unreadable on mobile
