...
version: ""
license: ""
installCmd: "hermes skills install clawhub/docker-sandbox"
sourceUrl: "https://clawhub.ai/skills/docker-sandbox"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/docker-sandbox`
- **Source URL:** [https://clawhub.ai/skills/docker-sandbox](https://clawhub.ai/skills/docker-sandbox)
...
```bash
hermes skills install clawhub/docker-sandbox
```
