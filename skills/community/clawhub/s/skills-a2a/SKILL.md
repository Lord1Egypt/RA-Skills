...
version: ""
license: ""
installCmd: "hermes skills install clawhub/skills-a2a"
sourceUrl: "https://clawhub.ai/skills/skills-a2a"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/skills-a2a`
- **Source URL:** [https://clawhub.ai/skills/skills-a2a](https://clawhub.ai/skills/skills-a2a)
...
```bash
hermes skills install clawhub/skills-a2a
```
