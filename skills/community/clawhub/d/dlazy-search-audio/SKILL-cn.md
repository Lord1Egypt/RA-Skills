...
version: 1.2.0
description: 音频搜索工具：检索 Pixabay Music，并返回免版税音乐链接与元数据，适合挑选背景音乐。
metadata:
  {
    'clawdbot':
      {
    ...
    'openclaw': { 'systemPrompt': '当调用此技能时，可以使用 dlazy search_audio -h 查看帮助信息。' },
  }
---
...
音频搜索工具：检索 Pixabay Music，并返回免版税音乐链接与元数据，适合挑选背景音乐。
