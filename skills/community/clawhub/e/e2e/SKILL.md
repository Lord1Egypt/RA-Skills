...
version: ""
license: ""
installCmd: "hermes skills install clawhub/e2e"
sourceUrl: "https://clawhub.ai/skills/e2e"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/e2e`
- **Source URL:** [https://clawhub.ai/skills/e2e](https://clawhub.ai/skills/e2e)
...
```bash
hermes skills install clawhub/e2e
```
