...
exports.COMPILED_RULES = exports.SCANNABLE_EXTENSIONS = exports.VERSION = void 0;
exports.VERSION = '0.97';
exports.SCANNABLE_EXTENSIONS = new Set(['.md', '.js', '.ts', '.py', '.sh', '.json', '.yaml', '.yml']);
// ============================================================
// 21 条安全规则
// ============================================================
const RULES = [
...
exports.COMPILED_RULES = RULES.map(r => ({
    ...r,
...
//# sourceMappingURL=skill-safety-rules.js.map