...
version: ""
license: ""
installCmd: "hermes skills install clawhub/tldr-prompt"
sourceUrl: "https://clawhub.ai/skills/tldr-prompt"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/tldr-prompt`
- **Source URL:** [https://clawhub.ai/skills/tldr-prompt](https://clawhub.ai/skills/tldr-prompt)
...
```bash
hermes skills install clawhub/tldr-prompt
```
