...
version: ""
license: ""
installCmd: "hermes skills install clawhub/claude-md-initializer"
sourceUrl: "https://clawhub.ai/skills/claude-md-initializer"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/claude-md-initializer`
- **Source URL:** [https://clawhub.ai/skills/claude-md-initializer](https://clawhub.ai/skills/claude-md-initializer)
...
```bash
hermes skills install clawhub/claude-md-initializer
```
