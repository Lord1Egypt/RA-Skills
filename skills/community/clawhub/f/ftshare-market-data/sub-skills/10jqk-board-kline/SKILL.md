...
|------|------|
| 接口名称 | 查询同花顺板块历史 K 线 |
| 外部接口 | `GET /data/api/v1/market/data/ths-board-kline` |
| 请求方式 | GET |
...
```
GET https://market.ft.tech/data/api/v1/market/data/ths-board-kline?board_code=885311&page=1&page_size=20
```
