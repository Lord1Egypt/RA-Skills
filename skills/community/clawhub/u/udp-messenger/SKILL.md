...
version: ""
license: ""
installCmd: "hermes skills install clawhub/udp-messenger"
sourceUrl: "https://clawhub.ai/skills/udp-messenger"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/udp-messenger`
- **Source URL:** [https://clawhub.ai/skills/udp-messenger](https://clawhub.ai/skills/udp-messenger)
...
```bash
hermes skills install clawhub/udp-messenger
```
