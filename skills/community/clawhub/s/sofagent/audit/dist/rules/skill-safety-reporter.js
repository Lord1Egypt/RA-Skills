...
exports.printFileResult = printFileResult;
exports.printTerminalSummary = printTerminalSummary;
exports.printJsonOutput = printJsonOutput;
exports.printQuietOutput = printQuietOutput;
...
const NC = '\x1b[0m';
/** 单文件终端输出 */
function printFileResult(file, hits, verdict) {
    if (verdict === 'SAFE') {
...
/** 终端模式总结输出 */
function printTerminalSummary(result, safeCount, dangerousCount, suspiciousCount) {
    console.log('');
...
function printQuietOutput(verdict) {
    console.log(verdict);
}
...
//# sourceMappingURL=skill-safety-reporter.js.map