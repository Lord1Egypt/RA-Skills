...
version: ""
license: ""
installCmd: "hermes skills install clawhub/test"
sourceUrl: "https://clawhub.ai/skills/test"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/test`
- **Source URL:** [https://clawhub.ai/skills/test](https://clawhub.ai/skills/test)
...
```bash
hermes skills install clawhub/test
```
