...
version: ""
license: ""
installCmd: "hermes skills install clawhub/git-commit-pr-workflow"
sourceUrl: "https://clawhub.ai/skills/git-commit-pr-workflow"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/git-commit-pr-workflow`
- **Source URL:** [https://clawhub.ai/skills/git-commit-pr-workflow](https://clawhub.ai/skills/git-commit-pr-workflow)
...
```bash
hermes skills install clawhub/git-commit-pr-workflow
```
