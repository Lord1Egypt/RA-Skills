...
exports.checkRuleA8 = checkRuleA8;
...
function checkRuleA8(ctx) {
    ...
    if ((0, log_checker_1.hasTestOrBuildExecution)(logEntries)) {
        rule.status = 'PASS';
    }
    else {
        rule.status = 'FAIL';
...
//# sourceMappingURL=rule-a8-verify-before-continue.js.map