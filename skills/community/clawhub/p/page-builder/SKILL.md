...
version: ""
license: ""
installCmd: "hermes skills install clawhub/page-builder"
sourceUrl: "https://clawhub.ai/skills/page-builder"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/page-builder`
- **Source URL:** [https://clawhub.ai/skills/page-builder](https://clawhub.ai/skills/page-builder)
...
```bash
hermes skills install clawhub/page-builder
```
