...
description: 搜索万豪集团旗下W酒店并返回实时价格与预订链接，支持酒店详情查询和套餐优惠搜索，多旅游平台数据直连。
tags: [W酒店, W Hotels, 万豪, 酒店预订, hotel]
tools:
  - name: search
...
搜索W酒店（W Hotels），返回真实价格和可预订链接，支持酒店详情和套餐优惠查询。

## 使用场景

- 用户明确要**搜索或预订W酒店**时使用
- 用户说「帮我找上海的W酒店」「广州W酒店多少钱」等
- 不在用户仅提及品牌名但无搜索意图时触发

## 能做什么

- 搜索W酒店，返回价格、星级、地址、附近地标和预订链接
- 查询某家W酒店的详情（周边交通/景点/设施/房型/政策）
- 搜索W酒店套餐优惠
...
1. 「上海有什么W酒店」→ search
2. 「上海800块以内的W酒店」→ search + max_price
3. 「上海W酒店怎么样」→ detail
4. 「W酒店有什么优惠套餐」→ packages
