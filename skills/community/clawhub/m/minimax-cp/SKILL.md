...
version: ""
license: ""
installCmd: "hermes skills install clawhub/minimax-cp"
sourceUrl: "https://clawhub.ai/skills/minimax-cp"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/minimax-cp`
- **Source URL:** [https://clawhub.ai/skills/minimax-cp](https://clawhub.ai/skills/minimax-cp)
...
```bash
hermes skills install clawhub/minimax-cp
```
