...
version: ""
license: ""
installCmd: "hermes skills install clawhub/codex-sub-agents-1"
sourceUrl: "https://clawhub.ai/skills/codex-sub-agents-1"
---
...
- **License:** 
- **Platforms:** All
- **Install Command:** `hermes skills install clawhub/codex-sub-agents-1`
- **Source URL:** [https://clawhub.ai/skills/codex-sub-agents-1](https://clawhub.ai/skills/codex-sub-agents-1)
...
```bash
hermes skills install clawhub/codex-sub-agents-1
```
