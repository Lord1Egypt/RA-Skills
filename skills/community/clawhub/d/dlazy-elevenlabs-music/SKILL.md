...
version: 1.2.0
description: ElevenLabs music_v1 model — generates 10–300s original music from a natural-language prompt. Good for BGM, ads, and short-video soundtracks.
metadata:
  {
    'clawdbot':
      {
    ...
    'openclaw': { 'systemPrompt': 'When invoking this skill, use dlazy elevenlabs-music -h for help.' },
  }
---
