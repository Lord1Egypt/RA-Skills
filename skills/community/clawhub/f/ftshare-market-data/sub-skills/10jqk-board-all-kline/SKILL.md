...
|------|------|
| 接口名称 | 查询同花顺全板块 K 线 |
| 外部接口 | `GET /data/api/v1/market/data/ths-all-board-kline` |
| 请求方式 | GET |
...
```
GET https://market.ft.tech/data/api/v1/market/data/ths-all-board-kline?start_date=2021-10-01&end_date=2021-10-31&page=1&page_size=50
```
